          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="dark:bg-slate-900 bg-slate-100 border dark:border-slate-850 border-slate-300 rounded-xl p-5 flex flex-wrap items-center justify-between gap-4">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="flex bg-black/40 p-1 rounded-lg border dark:border-slate-850 border-slate-300">
                  <button 
                    onClick={() => handleControl(workerStatus === 'paused' ? 'running' : 'paused')}
                    className={`flex items-center gap-1.5 px-3 py-1 rounded-md text-xs font-bold transition-all ${workerStatus === 'paused' ? 'bg-emerald-600 hover:bg-emerald-500 dark:text-white text-black shadow-md' : 'hover:dark:bg-slate-800 bg-slate-200 dark:text-slate-300 text-slate-700'}`}
                  >
                  ...
                  <button 
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1 rounded-md text-xs font-bold transition-all ${workerStatus === 'stop_after_current' ? 'bg-amber-600 dark:text-white text-black shadow-md' : 'hover:dark:bg-slate-800 bg-slate-200 dark:text-slate-300 text-slate-700'}`}
                  >
